...
die Entwicklung und Lancierung von neuen journalistischen Formaten;
Unterstützung von Projekten, die dem Genossenschaftszweck entsprechen;
Mittelbeschaffung;
Entwicklung von IT-Applikationen, bevorzugt Open Source;
Zurverfügungstellung und Finanzierung von Infrastruktur;
Übersetzung und Verbreitung von journalistischen Inhalten;
Erbringung und Ermöglichung von Rechts- und anderer Beratung, wie auch der Durchsetzung von rechtlichen und anderen Ansprüchen;
Ausbildung von journalistischem Nachwuchs;
Entwicklung von neuen Verbreitungskanälen für journalistische Inhalte, sei dies als Eigenentwicklung oder durch Unterstützen von Drittentwicklungen;
Unterstützung hervorragender Recherchen und journalistischer Projekte; 
Anschubfinanzierung von Projekten, die dem Zweck der Genossenschaft dienen; und
Durchführung von Ausbildungs-, Informations- und Debattenveranstaltungen, insbesondere auch an Schulen und in der Öffentlichkeit.
