  ...
  <Loader loading={loading} error={error} render={() => {
    ...
    return (
      <div>
        ...
        <P>
          Denn darüber besteht einige Unklarheit. Immerhin haben Sie den Weltrekord für Medien-Crowdfundings gebrochen. Seitdem florierten die Spekulationen: Bis zur Vermutung, dass Sie in Wahrheit eine Roboterarmee seien, die von einem geschickten Financier zwecks verdeckter Zahlung aufgeschaltet wurde.
        </P>

        <P>
          Nun, wir wollen die Fakten sprechen lassen - selbst, wenn sie weniger interessant sind als als die Roboterarmee. Unser IT-Team hat ihre Daten (selbstverständlich anonym) ausgewertet. Und Thomas Preusse und Patrick Recher haben sie (oder sollte man schrieben: Sie?) in Grafiken verpackt.
        </P>
        ...
        <P>
          Auf der unterstehenden Karte sehen Sie die Verteilung der Republik-Mitglieder: In Zürich. Dann, sobald Sie zoomen, in der Schweiz. Und schliesslich im deutschsprachigen Raum.
        </P>
